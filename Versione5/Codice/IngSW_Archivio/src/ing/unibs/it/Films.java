...
public class Films  implements Serializable{
	...
	/**
	 * ragruppa film rimossi
	 * @return array
	 */
	public ArrayList<Risorsa> filmsRimossiUniforme(){
		ArrayList<Risorsa> tutti= new ArrayList<Risorsa>();
		for(Risorsa risorsa: filmsIng.getRisorseRimosse()) 
			tutti.add(risorsa);
		for(Risorsa risorsa: filmsIta.getRisorseRimosse()) 
			tutti.add(risorsa);
