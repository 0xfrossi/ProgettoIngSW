...
public class MyUtil {
	...
	/**
	 * Aggiungi tutti gli autori contenuti nell'array alla stringa
	 * @param str il builder da utilizzare
	 * @return la stringa di autori
	 */
	public static String stampaArray(StringBuilder str, ArrayList<String> array) {
	...
	public static GregorianCalendar dataCorrente() {
		...
		GregorianCalendar corrente=(GregorianCalendar) GregorianCalendar.getInstance();
		return corrente;
	}
