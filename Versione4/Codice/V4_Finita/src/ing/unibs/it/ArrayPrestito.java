...
public class ArrayPrestito implements Serializable {
	...
	/**
	 * Stampa i titoli dei prestiti esistenti
	 */
	...
	/**
	 * Stampa i dati di tutti i prestiti
	 * @param stampa l'array da stampare
	 */
	public void stampaPrestitiUtente(ArrayList<Prestito> stampa) {
		if(!stampa.isEmpty()) {
		for(int i=0;i<stampa.size();i++) {
			System.out.println();
			stampa.get(i).stampaPrestito();
			System.out.println();	
		}
	}
		else
	 ...
	 * @param fruitore il fritore che chiede
	...
	/**
	 * Permette di chiedere un film in prestito, previo controllo sul numero di film gia' in prestito
	 * @param fruitore il fruitore
	 * @param film il film
	 */
